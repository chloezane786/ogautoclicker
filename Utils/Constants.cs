namespace OGAutoClicker.Utils
{
    ...
    {
        public const string MAIN_WINDOW_TITLE_DEFAULT = "OG Auto Clicker";
        ...
        public const string SYSTEM_TRAY_MENU_SHOW = "Show OG Auto Clicker";
        ...
        public const string SETTINGS_FILE_PATH = "OGAutoClicker_Settings.json";
        public const string LOG_FILE_PATH = "OGAutoClicker_Logs.txt";
